...
class LotesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'metros_iniciales' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        ...
        '_constraints' => [
            ...
            'fk_materiales_lotes_materiales1' => ['type' => 'foreign', 'columns' => ['id'], 'references' => ['materiales', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
