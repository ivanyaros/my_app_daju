...
class MaquinasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'maquinacol' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'maquinacol' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
