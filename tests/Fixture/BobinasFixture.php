 ...
 *
 */
class BobinasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'en_uso' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'terminado' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_materiales_bobinas_materiales1' => ['type' => 'foreign', 'columns' => ['id'], 'references' => ['materiales', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'metros_netos' => 1,
            'metros_actuales' => 1,
            'en_uso' => 'Lorem ipsum dolor sit amet',
            'terminado' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
