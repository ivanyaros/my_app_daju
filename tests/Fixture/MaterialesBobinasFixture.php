...
/**
 * MaterialesBobinasFixture
 *
 */
class MaterialesBobinasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['materiale_id'], 'length' => []],
            'fk_materiales_bobinas_materiales1' => ['type' => 'foreign', 'columns' => ['materiale_id'], 'references' => ['materiales', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
