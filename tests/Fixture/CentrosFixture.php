...
class CentrosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'centroscol' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'centroscol' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
